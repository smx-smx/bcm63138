...
extern void bwdpi_monitor_stat(long int *retval, struct request_rec *r);
extern void bwdpi_monitor_info(char *type, char *event, long int *retval, struct request_rec *r);
extern void bwdpi_monitor_ips(char *type, char *date, long int *retval, struct request_rec *r);
extern void bwdpi_monitor_nonips(char *type, char *date, long int *retval, struct request_rec *r);
